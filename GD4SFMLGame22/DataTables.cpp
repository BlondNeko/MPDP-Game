...
{
	std::vector<BikeData> data(static_cast<int>(BikeType::kNormal));

	data[static_cast<int>(BikeType::kNormal)].m_hitpoints = 100;
	data[static_cast<int>(BikeType::kNormal)].m_initial_speed = 100.f;
	data[static_cast<int>(BikeType::kNormal)].m_offroad_resistance = 0.1f;
	data[static_cast<int>(BikeType::kNormal)].m_texture = Textures::kNormal;


	data[static_cast<int>(BikeType::kNitro)].m_hitpoints = 80;
	data[static_cast<int>(BikeType::kNitro)].m_initial_speed = 110.f;
	...
	data[static_cast<int>(BikeType::kOffroader)].m_initial_speed = 80.f;
	...
	data[static_cast<int>(BikeType::kRacer)].m_hitpoints = 60;
	data[static_cast<int>(BikeType::kRacer)].m_initial_speed = 110.f;
	...
	data[static_cast<int>(BikeType::kSpecialA)].m_hitpoints = 40;
	data[static_cast<int>(BikeType::kSpecialA)].m_initial_speed = 140.f;
	data[static_cast<int>(BikeType::kSpecialA)].m_offroad_resistance = 0.1f;
	...
	data[static_cast<int>(BikeType::kSpecialB)].m_initial_speed = 140.f;
	data[static_cast<int>(BikeType::kSpecialB)].m_offroad_resistance = 0.1f;
	data[static_cast<int>(BikeType::kSpecialB)].m_texture = Textures::kSpecialB;


	data[static_cast<int>(BikeType::kSpecialC)].m_hitpoints = 160;
	data[static_cast<int>(BikeType::kSpecialC)].m_initial_speed = 80.f;
	...
	data[static_cast<int>(BikeType::kSpecialD)].m_hitpoints = 160;
	data[static_cast<int>(BikeType::kSpecialD)].m_initial_speed = 80.f;
...
{
	std::vector<ObstacleData> data(static_cast<int>(ObstacleType::kBarrier));

	data[static_cast<int>(ObstacleType::kBarrier)].m_texture = Textures::kObstacle1;
	data[static_cast<int>(ObstacleType::kBarrier)].m_action = [](Bike& a) {a.Damage(15); };
	data[static_cast<int>(ObstacleType::kTarSpill)].m_speed_down = 1.f;

	data[static_cast<int>(ObstacleType::kAcidSpill)].m_texture = Textures::kAcidSpill;
	data[static_cast<int>(ObstacleType::kAcidSpill)].m_action = [](Bike& a) {a.Damage(5); };
	data[static_cast<int>(ObstacleType::kTarSpill)].m_speed_down = 0.2f;

	data[static_cast<int>(ObstacleType::kTarSpill)].m_texture = Textures::kTarSpill;
	data[static_cast<int>(ObstacleType::kTarSpill)].m_action = [](Bike& a) {a.Damage(2); };
	data[static_cast<int>(ObstacleType::kTarSpill)].m_speed_down = 0.5f;
	return data;
}
